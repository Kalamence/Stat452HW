...
auto.linear <- svm(above_med ~. - mpg, data = Auto, kernal = "linear", cost = 10)
```
...
auto.rad <- svm(above_med ~. - mpg, data = Auto, kernal = "radial", cost = 1, gamma = 1)
...
auto.poly <- svm(above_med ~. - mpg - name, data = Auto, kernal = "polynomial", cost = 1, gamma = 1)
